...
const KL_RENK_PAKETI = ['#1E88E5','#43A047','#FB8C00','#8E24AA','#00897B','#D81B60','#FFB300','#7E57C2', '#1E88E5','#43A047','#FB8C00','#8E24AA','#00897B','#D81B60','#FFB300','#7E57C2',
  '#1976D2','#2196F3','#42A5F5','#00ACC1','#26C6DA','#0097A7',
  '#2E7D32','#4CAF50','#66BB6A','#7CB342','#8BC34A','#9CCC65',
  '#F57C00','#FF9800','#FFA726','#FFC107','#FFD54F',
  '#E53935','#F4511E','#EF5350','#EC407A','#F06292',
  '#9C27B0','#AB47BC','#5E35B1','#3949AB','#3F51B5','#5C6BC0',
  '#009688','#26A69A','#795548','#8D6E63','#546E7A','#607D8B',
  '#78909C','#37474F','#263238','#5E81AC','#00B8D4','#00C853',
  '#64DD17','#FFD600','#FF6D00','#FF1744','#C51162','#651FFF',
