...
function ogretmenDetayAc(id){
  ...
  document.getElementById('detayBody').innerHTML = `
    <div class="detay-card">
      ...
      ${(o.kadroKademesi||(o.gorevYeriKademeleri&&o.gorevYeriKademeleri.length)||o.gorevYeriKademesi)?`<div class="detay-row">Okul: ${kademeHucresi(o)}${(function(){ var fiili=kademeFiiliListesi(o); var kadro=o.kadroKademesi||''; var farkli = kadro && fiili.length && !(fiili.length===1 && fiili[0]===kadro); return (kadro && farkli) ? ' <span class="detay-row-muted">(Kadrosu: '+kademeEtiket(kadro)+')</span>' : ''; })()}</div>`:''}
